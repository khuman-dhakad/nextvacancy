    ...
    >
      <Container size="lg" className="space-y-8">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2.5">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-[var(--primary)] text-xs font-bold border border-blue-200/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <Card className="bg-gradient-to-br from-emerald-950 via-[#062419] to-[#041B13] text-white p-7 rounded-2xl border border-emerald-800/80 shadow-md flex flex-col justify-between space-y-6 group hover:border-emerald-500 transition-all duration-200">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-bold text-emerald-300 bg-emerald-900/60 px-2.5 py-0.5 rounded-full border border-emerald-700/60">
                  850K+ Subscribers
                </span>
              </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              >
                <Button
                  ...
                  size="md"
                  fullWidth
                  className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl min-h-[44px] shadow-sm flex items-center justify-center gap-2"
                >
          ...
          <Card className="bg-gradient-to-br from-[#08223D] via-[#0B2E52] to-[#0E3A66] text-white p-7 rounded-2xl border border-sky-800/80 shadow-md flex flex-col justify-between space-y-6 group hover:border-sky-500 transition-all duration-200">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-bold text-sky-300 bg-sky-900/60 px-2.5 py-0.5 rounded-full border border-sky-700/60">
                  650K+ Members
                </span>
              </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              >
                <Button
                  ...
                  size="md"
                  fullWidth
                  className="bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs rounded-xl min-h-[44px] shadow-sm flex items-center justify-center gap-2"
                >
